const { SlashCommandBuilder, EmbedBuilder, InteractionReplyOptions, Flags } = require('discord.js');
...
module.exports = {
  ...
  async execute(i) {
    // ✅ 新しい書き方：ephemeral → flags に変更
    await i.deferReply({ flags: 64 }); // 64 = Ephemeral（自分だけに表示）
